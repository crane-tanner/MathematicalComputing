    ...
    for x, doc in enumerate(docs_x):
        ...
        for w in words: 
            if w in wrds:
                ...
                bag.append(0) # putting 0 if word does not exists
...
net = tflearn.fully_connected(net, len(output[0]), activation = "softmax") #generate probabilities for each neuron in layer 
...
chat() #initiating chatbot() function 
